...
def main():
    ...
    education_level = input("What is your highest level of education? ")
    interests = []
    skills = []

    print(f"Hi, {name}! Let's figure out some potential career options for you.  We'll begin by getting a bit of background on your interests and skills.")
    
    num_interests = int(input("How many interests do you have? (Please limit your answer to 3 interests)"))
    num_skills = int(input("How many skills do you have? (Please limit your answer to 3 skills)"))

    for i in range(num_interests):
        interest = input(f"What is your interest #{i+1}? ")
        interests.append(interest)

    for i in range(num_skills):
        skill = input(f"What is your skill #{i+1}? ")
        skills.append(skill)
